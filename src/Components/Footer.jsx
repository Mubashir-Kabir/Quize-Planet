...
export const Footer = () => {
  return (
    <div className="px-4 pt-16 mx-auto bg-gray-200 sm:max-w-xl md:max-w-full md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 mb-8 text-left sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        ...
        <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
          <li>
            <a
              href="/"
              className="text-sm text-gray-600 transition-colors duration-300 hover:text-amber-400"
            >
              F.A.Q
            </a>
          </li>
